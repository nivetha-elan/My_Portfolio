  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Nivetha Elangovan",
          from_email: form.email,
          to_email: "nivetha.aurora@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:nivetha.aurora@gmail.com" target="_blank" className="blue-text-gradient">nivetha.aurora@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
